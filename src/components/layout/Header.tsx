...
*/
/*  ---------------KULLANICI GİRİŞİ DÜZENLENMEDEN ÖNCE-----------
...
export default function Header() {
  ...
  useEffect(() => {
    ...
    // Diğer sekmelerde localStorage değiştiğinde de güncelle
    const onStorage = (e: StorageEvent) => {
      if (e.key === null || e.key === undefined) {
        // tüm storage değişimi: yeniden okuma yap
        setCartCount(getCartCount());
      } else if (e.key === "pasaj_cart") {
        setCartCount(getCartCount());
      }
    };

    // aynı sekme içi custom event
